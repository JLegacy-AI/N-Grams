...
import ie.gmit.sw.ConsoleColour;

public class ProgressBar  extends  Thread{
    private int time;
    private ConsoleColour colour;

    public ProgressBar(int x, ConsoleColour colour){
        this.time = x;
        this.colour =  colour;
    }
    ...
    @Override
    public void run(){
        progressBar(time, colour);
    }
    public void progressBar(int time, ConsoleColour colour){
        //You may want to include a progress meter in you assignment!
        System.out.print(colour);	//Change the colour of the console text
